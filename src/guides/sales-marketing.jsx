...
// Sales & Marketing resource guide.
...
<main className="rg-main">
          ...
          <section className="rg-hero rg-section">
            <FadeUp>
              <h1><span className="rg-gold">Sales & Marketing</span> Job Seekers 🇦🇺<span style={{display: 'none'}}>[cite: 1]</span></h1>
          ...
          <section className="rg-section">
            <FadeUp>
              ...
              <p className="rg-p">Since you are looking for Sales & Marketing Jobs, we gathered as many resources as possible to help your job search! Here’s Something you need to know:<span style={{display: 'none'}}>[cite: 2, 3]</span></p>
              ...
              <div className="rg-steps">
                ...
                <div className="rg-step">
                  ...
                  <div className="rg-step-body">
                    ...
                    <blockquote>“Suggest me passion project ideas I can do to build my portfolio targeting Sales, Marketing, Digital Marketing, Business Development or Account Management jobs in [city/state], Australia. The projects should show I understand the Australian market, local customer behaviour, campaign strategy, sales processes and industry tools.”<span style={{display: 'none'}}>[cite: 10]</span></blockquote>
                  </div>
                </div>
                <div className="rg-step">
          ...
          <section className="rg-section">
            <FadeUp>
              ...
              <p className="rg-p">
                Go to marketing, digital, advertising, sales and business-development events in your target city.
                These are useful places to meet marketers, agency professionals, sales leaders, account managers,
                business-development professionals and hiring managers already working in Australia.
              </p>

              <div className="rg-callout">
                <p className="rg-p">
                  Here are 2 useful places to keep checking for Sales &amp; Marketing events in Australia.
                </p>
              </div>

              <div className="rg-link-list">
                <a
                  href="https://ami.org.au/events/"
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  href="https://conferencealerts.co.in/australia/marketing"
                  target="_blank"
                  rel="noreferrer"
                  className="rg-link-item"
                >
                  <div className="rg-link-item-left">
                    ...
                    Conference Alerts — Marketing Conferences in Australia
                  </div>
                  <ExternalLink size={20} opacity={0.3} />
                </a>
              </div>
              ...
              <p className="rg-p">
                Tip: Don’t only look for career fairs. Marketing conferences, brand events,
                digital-marketing meetups, agency events, sales workshops and business networking
                sessions can be much better places to make useful professional connections.
              </p>
            </FadeUp>
          </section>
          ...
          <section className="rg-section">
            <FadeUp>
              ...
              <p className="rg-p">
                For Sales &amp; Marketing roles, focus on skills employers can actually use:
                campaign planning, digital marketing, social media, customer acquisition,
                analytics, lead generation, prospecting, consultative selling and sales strategy.
              </p>

              <div className="rg-callout">
                <p className="rg-p">
                  A useful combination is an <strong className="rg-accent">Australian course source</strong>
                  plus a recognised global platform such as Coursera.
                </p>
              </div>

              <div className="rg-course-category">
                <p className="rg-course-category-title">TAFE Courses — Marketing &amp; Digital Marketing</p>

                <p className="rg-p">
                  TAFE Courses lets you compare Australian marketing qualifications and online programs
                  from different education providers.
                </p>

                <a
                  href="https://www.tafecourses.com.au/courses/marketing/"
                  target="_blank"
                  rel="noreferrer"
                ...
                <a
                  href="https://www.tafecourses.com.au/courses/digital-marketing/"
                  target="_blank"
                  rel="noreferrer"
                  className="rg-course-item"
                >
                ...
                <a
                  href="https://www.tafecourses.com.au/courses/marketing/certificate-iv/"
                  target="_blank"
                  rel="noreferrer"
                  className="rg-course-item"
                >
                  <ArrowRight size={20} className="rg-course-icon" />
                  Certificate IV Marketing Options
                </a>

                <a
                  href="https://www.tafecourses.com.au/courses/marketing/diploma/"
                  target="_blank"
                  rel="noreferrer"
                  className="rg-course-item"
                >
                  <ArrowRight size={20} className="rg-course-icon" />
                  Diploma Marketing Options
                </a>
              </div>

              <div className="rg-course-category">
                <p className="rg-course-category-title">Coursera — Marketing</p>

                <p className="rg-p">
                  If you are targeting Marketing, Digital Marketing, Brand, Content or Campaign roles,
                  build skills around digital channels, audience strategy, campaign execution and measurement.
                </p>
                ...
                >
                  <ArrowRight size={20} className="rg-course-icon" />
                  Digital Marketing Specialization — University of Illinois Urbana-Champaign
                </a>

                <a
                  href="https://www.coursera.org/specializations/digital-marketing-strategy-execution"
                  target="_blank"
                  rel="noreferrer"
                  className="rg-course-item"
                >
                  <ArrowRight size={20} className="rg-course-icon" />
                  Digital Marketing: Audience, Campaigns &amp; Metrics
                </a>
              </div>

              <div className="rg-course-category">
                <p className="rg-course-category-title">Coursera — Sales &amp; Business Development</p>

                <p className="rg-p">
                  If you are targeting Sales Representative, Account Executive, Business Development
                  or Account Management roles, focus on prospecting, qualification, consultative selling,
                  objection handling and sales strategy.
                </p>

                <a
                  href="https://www.coursera.org/specializations/sales-training-high-performing-teams"
                  target="_blank"
                  rel="noreferrer"
                  className="rg-course-item"
                >
                ...
                <a
                  href="https://www.coursera.org/specializations/sage-selling-and-sales-management"
                  target="_blank"
                  rel="noreferrer"
                  className="rg-course-item"
                >
              ...
              <div className="rg-callout">
                <p className="rg-p">
                  <strong className="rg-accent">How to choose:</strong> If you are targeting Marketing,
                  Brand, Social Media or Digital roles, start with Marketing or Digital Marketing.
                  If you are targeting Sales, Account Executive or Business Development roles,
                  start with the sales-focused Coursera programs.
                </p>
              </div>
            </FadeUp>
          </section>
          ...
          <section className="rg-section">
            <FadeUp>
              ...
              <p className="rg-p">
                For Sales &amp; Marketing candidates, look for volunteer work involving social media,
                communications, fundraising, events, sponsorships, community engagement,
                content creation, customer outreach or business development.
              </p>
              ...
              <p className="rg-p">
                Search terms such as marketing, social media, communications, fundraising,
                events, sponsorship, sales and community engagement to find opportunities
                closer to your target roles.
              </p>
            </FadeUp>
          </section>
