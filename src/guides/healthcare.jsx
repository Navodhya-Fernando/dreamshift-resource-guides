...
<main className="rg-main">
          ...
          <section className="rg-hero rg-section">
            <FadeUp>
              <h1><span className="rg-gold">Healthcare</span> Job Seekers 🇦🇺<span style={{display: 'none'}}>[cite: 1]</span></h1>
          ...
          <section className="rg-section">
            <FadeUp>
              ...
              <p className="rg-p">Since you are looking for Healthcare Jobs, we gathered as many resources as possible to help your job search! Here’s Something you need to know:<span style={{display: 'none'}}>[cite: 2, 3]</span></p>
